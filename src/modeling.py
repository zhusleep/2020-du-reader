...
class BertModel(PreTrainedBertModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True):
        ...
        qattention_mask =  ~token_type_ids
        cattention_mask = ~qattention_mask
        # print('*************************')
...
class BertForQuestionAnswering(PreTrainedBertModel):
    ...
    def __init__(self, config):
        ...
        self.LayerNorm = BertLayerNorm(config.hidden_size, eps=1e-12)
        self.endLSTM = nn.LSTM(2 * config.hidden_size, config.hidden_size, num_layers=1, batch_first=True, dropout=0.1,
                               bidirectional=False)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, start_positions=None, end_positions=None):
        extended_attention_mask, c_attention_mask, q_attention_mask, sequence_output = self.bert(input_ids,
                                                                                                 token_type_ids,
                                                                                                 attention_mask,
                                                                                                 output_all_encoded_layers=False)
        ...
        encoded_skip_start = self.skip_encoder_start(sequence_output1d, extended_attention_mask,
                                                     output_all_encoded_layers=False)
        encoded_skip_end = self.skip_encoder_end(sequence_output1d, extended_attention_mask,
                                                 output_all_encoded_layers=False)
